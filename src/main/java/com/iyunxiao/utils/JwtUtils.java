...
public class JwtUtils {
     ...
     * JWT 生成密钥使用的密码
     */
    private static final String JWT_RULE = "mrqasim";

    /**
     * JWT 添加至HTTP HEAD中的前缀
     */
    private static final String JWT_SEPARATOR = "iyx";
    ...
    public static String buildJWT(SignatureAlgorithm alg, Key key, String sub, String aud, String jti, String iss, Date nbf, Integer duration) {
        ...
        DateTime exp = null;
        if (duration != null) {exp = (nbf == null ? iat.plusSeconds(duration) : new DateTime(nbf).plusSeconds(duration));}
